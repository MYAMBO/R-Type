...
void Game::createPlayer()
{
    ...
    player->addComponent<Sprite>(std::string("../sprites/r-typesheet25.gif"));
    player->addComponent<Animator>(16, 4, 0.1f, 0, 0, 33, 33, 0, 0);
    ...
    fire->addComponent<Animator>(2, 1, 0.1f, 285, 85, 15, 15, 20, 0);
...
void Game::createLaser(int entityId)
{
    ...
    laser->addComponent<Animator>(-5, 0.05f, 200, 120, 32, 15, 32, 0);
